...
const Producttable = () => {
  ...
  // use state for delete data from the table
      ...
      <div className='container'>
        <form onSubmit={handleFormSubmit}>
          ...
          <div className='mt-3'>
            ...
            {/* work on this */}
            <select id='category' className='form-control' onChange={handleInputChange} name='category'  value={formData.category}>
              
              <option id='category' onChange={handleInputChange}  value={formData.category} >food</option>
              <option id='category' onChange={handleInputChange}  value={formData.category}>electronic</option> </select>
          </div>
